...
export function GalleryStrip() {
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-[1400px] gap-14 lg:grid-cols-[minmax(260px,0.32fr)_minmax(0,1fr)] lg:gap-10 xl:gap-12">
          ...
          {galleryImages.map((image, index) => (
            <Reveal key={image.src} delay={index * 0.05}>
              <Link
                ...
                className="group relative block aspect-[4/5] min-h-[220px] overflow-hidden bg-[#e7e7e4] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#050505] sm:min-h-[260px] lg:min-h-0"
              >
                <Image
                  unoptimized
                  src={image.src}
                  alt={image.alt}
                  fill
                  sizes="(min-width: 1024px) 11vw, (min-width: 640px) 28vw, 48vw"
